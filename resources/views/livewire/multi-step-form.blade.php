  <form  wire:submit.prevent="register">
    ...
    <div id="step-1" class="clientFrom step p-0" data-id='1'>
      <div class="text-center pt-5">
        <img src="{{ asset('vendor/livewire/images/register-assets/mocal-logo.svg')}}" />
      </div>
      <div class="modal-px-60 pt-5">
        ...
        <div class="d-flex mt-4">
          ...
          <input
            ...
            class="input-style input-font-bold ps-3" wire:model="tel"
          />
        ...
        <div class="text-center">
          <span
            class="btn-purple-fill btn-width-sm mt-5 nextScreen next"  wire:click="firstStepSubmit"
          >
            Get Started
          </span>
          <div class="or"></div>
          <a href="register-google.html" class="btn-gray-border signupbtn mb-3">
            <img src="{{ asset('vendor/livewire/images/register-assets/ic-google.svg')}}" /> Sign Up with Google
          </a><br />

          <a href="#.html" class="btn-gray-border signupbtn mb-3">
            <img src="{{ asset('vendor/livewire/images/register-assets/ic-microsoft.svg')}}" /> Sign Up with Microsoft
          </a><br />
      ...
      <div class="modal-content radius24">
        <div class="pt-5">
          <div class="text-center border-btm">
            <img src="{{ asset('vendor/livewire/images/signin-assets/mocal-logo.svg')}}" class="logo-sm" />
          </div>
          ...
          <div class="modal-body pt-4 modal-px-60">
            ...
            <!-- <div class="mb-5"> -->
              ...
              <span class="text-danger">@error('editor'){{ $message }}@enderror</span>
            <!-- </div>                                        -->
          </div>

          <div class="text-center mt-5 pt-5 mb-5">
            <button type="button" class="btn btn-white-fill prevScreen prev">< Back</button>
            <button type="button" class="btn btn-purple-fill nextScreen next" wire:click="SecondStepSubmit"> Next </button>
          </div>
        </div>
      </div>
    </div>
                ...
                <div class="col-lg-12">                          
                  ...
                  <div class="inputfiles">
                    <div class="fileUploadWrap">
                        <div>
                            <img src="{{ asset('vendor/livewire/images/register-assets/upload-files.png')}}"
                                alt="" class="DropIcon" />
                            <input type="file" name="import_file" wire:model="profile_pic">
                        </div>
                        <div class="parawrap">
